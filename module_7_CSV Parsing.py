...
class OutputPath:
    def __init__(self):
        success_path = 'module_7/news.txt'
        ...
        fail_path = 'module_7/fail_' + str(current_date) + '_' + str(current_time) + '.txt'
        self.fail_filepath = os.path.abspath(fail_path)
        os.makedirs(os.path.dirname(self.fail_filepath), exist_ok=True)

        csv_words_path = 'module_7/csv_words_' + str(current_date) + '_' + str(current_time) + '.csv'
        self.csv_words_filepath = os.path.abspath(csv_words_path)
        os.makedirs(os.path.dirname(csv_words_path), exist_ok=True)

        csv_letters_path = 'module_7/csv_letters_' + str(current_date) + '_' + str(current_time) + '.csv'
...
class LettersCSVPublisher:
    ...
    @staticmethod
    def add_letters_to_csv(csv_path, list_with_dict, count_all_text):
